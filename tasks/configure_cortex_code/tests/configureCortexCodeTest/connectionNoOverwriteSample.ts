...
// Pre-seed a connection named [default] that must NOT be overwritten.
fs.mkdirSync(TEMP_CONNECTIONS_DIR, { recursive: true });
fs.writeFileSync(
    path.join(TEMP_CONNECTIONS_DIR, 'connections.toml'),
...
process.env['SNOWFLAKE_ACCOUNT'] = 'newacct';
process.env['SNOWFLAKE_USER'] = 'newuser';
